...
public class FragmentArtist extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View viewArtist= inflater.inflate(R.layout.fragmentartist,container,false);
        listView=(ListView)viewArtist.findViewById(R.id.artistListView);
    ...
    public void getArtistList() {
        ...
        if (musicCursor != null && musicCursor.moveToNext()) {
            ...
            while (musicCursor.moveToNext()) {
                ...
                songList.add(new Songs(null,title,null,album,null,null,artist));
            }
    ...
    public class SongAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            //map to song layout
            CardView songLay = (CardView) songInf.inflate(R.layout.artist, parent, false);
            //get title and artist views
            ImageView imageview = (ImageView) songLay.findViewById(R.id.songImage);
            TextView songView = (TextView) songLay.findViewById(R.id.song_artist);
